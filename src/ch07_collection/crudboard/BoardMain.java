...
public class BoardMain {
    public static void main(String[] args) {
        ...
        Board data02 = new Board(9, "우크라이나 전쟁", "김푸틴", "2025/07/17", 50);
        ...
        dao.insertData(new Board(7, "서이초등학교", "금잔디", "2025/12/15", 2));
        dao.insertData(new Board(6, "남극탐험", "이강우", "2025/07/05", 10));
        ...
        if (result != -1){
            ...
            System.out.println(deleteId + " 게시물을 발견하지 못하였습니다.");
        }
